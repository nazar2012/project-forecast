...
export const NatureSection = styled.section`
  ...
  &::before {
    ...
    filter: blur(35px);
    animation: ${lightAnimationOne} 12s ease-in-out infinite;
    pointer-events: none;
  ...
  &::after {
    ...
    $dark
      ? "rgba(255, 255, 255, 0.02)"
      : "rgba(210, 225, 220, 0.5)"};

    filter: blur(40px);
    animation: ${lightAnimationTwo} 15s ease-in-out infinite;
    pointer-events: none;
    transition: background 0.5s ease;
  }
...
export const Slide = styled.div`
  ...
  @media (max-width: 768px) {
    width: ${({ $position }) =>
    $position === 0 ? "420px" : "240px"};

    height: ${({ $position }) =>
    $position === 0 ? "260px" : "160px"};
  ...
  @media (max-width: 550px) {
    width: ${({ $position }) =>
    $position === 0 ? "300px" : "190px"};

    height: ${({ $position }) =>
    $position === 0 ? "200px" : "130px"};
  ...
  @media (max-width: 380px) {
    width: ${({ $position }) =>
    $position === 0 ? "270px" : "170px"};

    height: ${({ $position }) =>
    $position === 0 ? "180px" : "115px"};
...
export const Dot = styled.button`
  ...
  background: ${({ $active, $accentColor, $dark }) =>
    $active
      ? $accentColor
      : $dark
